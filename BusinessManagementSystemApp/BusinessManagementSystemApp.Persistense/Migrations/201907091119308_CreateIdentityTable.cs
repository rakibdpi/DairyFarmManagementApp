namespace BusinessManagementSystemApp.Persistense.Migrations
{
    ...
    public partial class CreateIdentityTable : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "dbo.AspControllerAndActionNames",
                c => new
                    {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        ControllerAndActionName = c.String(),
                        RoleId = c.String(),
                    })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.AspControllerAndActionNames");
        }
    }
}
