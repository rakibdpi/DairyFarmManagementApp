...
using BMSA.App.ViewModels.AccountViewModels;
...
namespace BMSA.App.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    var logingHistory = new LoginHistory()
                    {
                        UserName = model.UserName,
                        LoginDateTime = DateTime.Now
                    };
                    logingHistory.Mac = Request.UserHostAddress != null ? Server.HtmlEncode(Request.UserHostAddress) : "";

                    db.LoginHistories.Add(logingHistory);
                    db.SaveChanges();
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { FullName = model.FullName, UserName = model.UserName, Email = model.Email, PhoneNumber = model.PhoneNumber, Address = model.Address };
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> CreateRole(ApplicationRole model)
        {
            if (ModelState.IsValid)
            {
